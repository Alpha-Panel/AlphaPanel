window.colors = {
    ...
    function(a, e, t) {
        ...
        t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, {
            ...
            t(a).on("load", (function() {
                    ...
                    (n.hasClass("menu-collapsed") || "true" === localStorage.getItem("menuCollapsed")) && (r = !0),
                        (T.hasClass('dark-layout') || "true" === localStorage.getItem('current-skin')) && (s.addClass('dark-layout')),
        ...
        t(".nav-link-style").on("click", (function() {
                var a = z()
                    , e = ""
                    , n = localStorage.getItem("prev-skin", a)
                    , logo = t('#logo');
                e = "dark-layout" !== a ? "dark-layout" : a === n ? "light-layout" : n || "light-layout",
                    localStorage.setItem("prev-skin", a),
                    localStorage.setItem("current-skin", e),
                    function(a) {
                        ...
                        s.removeClass("semi-dark-layout dark-layout bordered-layout"),
                            "dark-layout" === l ? (s.addClass("dark-layout"),
                                ...
                                logo.attr('src', '/img/AlphaPanel-dark.svg'),
                                ...
                                logo.attr('src', '/img/AlphaPanel-white.svg'),
        ...
        localStorage.getItem("current-skin");
